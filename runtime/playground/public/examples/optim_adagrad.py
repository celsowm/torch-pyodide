"""Adagrad optimizer parity smoke.

Trains a tiny linear regression for 50 steps with Adagrad. Weights and data
are both fully deterministic so the loss trajectory is identical across real
PyTorch and torch-pyodide; the browser test compares the JSON payload
against the real-PyTorch reference.
"""
import json
