...
import tensorOpsPy from "../../python/torch/tensor_ops.py?raw";
import autogradEnginePy from "../../python/torch/autograd_engine.py?raw";
import autogradRulesPy from "../../python/torch/autograd_rules.py?raw";
import tensorBackwardOpsPy from "../../python/torch/tensor_backward_ops.py?raw";
import tensorFactoriesOpsPy from "../../python/torch/tensor_factories_ops.py?raw";
import tensorNnOpsPy from "../../python/torch/tensor_nn_ops.py?raw";
import tensorShapeUtilsPy from "../../python/torch/tensor_shape_utils.py?raw";
import tensorIndexingPy from "../../python/torch/_tensor_indexing.py?raw";
import tensorMathHelpersPy from "../../python/torch/_tensor_math_helpers.py?raw";
import tensorRuntimeBridgePy from "../../python/torch/_tensor_runtime_bridge.py?raw";
import tensorShapeOpsPy from "../../python/torch/_tensor_shape_ops.py?raw";
import tensorLinalgPy from "../../python/torch/_tensor_linalg_py.py?raw";
...
`);
  ...
  pyodide.FS.writeFile("/home/pyodide/torch/tensor_ops.py", tensorOpsPy);
  pyodide.FS.writeFile("/home/pyodide/torch/autograd_engine.py", autogradEnginePy);
  pyodide.FS.writeFile("/home/pyodide/torch/autograd_rules.py", autogradRulesPy);
  pyodide.FS.writeFile("/home/pyodide/torch/tensor_backward_ops.py", tensorBackwardOpsPy);
  pyodide.FS.writeFile("/home/pyodide/torch/tensor_factories_ops.py", tensorFactoriesOpsPy);
  pyodide.FS.writeFile("/home/pyodide/torch/tensor_nn_ops.py", tensorNnOpsPy);
  pyodide.FS.writeFile("/home/pyodide/torch/tensor_shape_utils.py", tensorShapeUtilsPy);
  pyodide.FS.writeFile("/home/pyodide/torch/_tensor_indexing.py", tensorIndexingPy);
  pyodide.FS.writeFile("/home/pyodide/torch/_tensor_math_helpers.py", tensorMathHelpersPy);
  pyodide.FS.writeFile("/home/pyodide/torch/_tensor_runtime_bridge.py", tensorRuntimeBridgePy);
  pyodide.FS.writeFile("/home/pyodide/torch/_tensor_shape_ops.py", tensorShapeOpsPy);
  pyodide.FS.writeFile("/home/pyodide/torch/_tensor_linalg_py.py", tensorLinalgPy);
...
import micropip
await micropip.install("torch-pyodide", reinstall=True, verbose=True)
`);
}
